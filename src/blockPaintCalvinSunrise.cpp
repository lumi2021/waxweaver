#include "blockPaintCalvinSunrise.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTCALVINSUNRISE::_bind_methods() {
}

BLOCKPAINTCALVINSUNRISE::BLOCKPAINTCALVINSUNRISE() {

    setTexture("res://items/paintings/calvinSunrise.png");
...
Dictionary BLOCKPAINTCALVINSUNRISE::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTCALVINSUNRISE::onBreak(int x, int y, PLANETDATA *planet, int dir){
