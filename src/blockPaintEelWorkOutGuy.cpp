#include "blockPaintEelWorkOutGuy.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTEELWORKOUTGUY::_bind_methods() {
}

BLOCKPAINTEELWORKOUTGUY::BLOCKPAINTEELWORKOUTGUY() {

    setTexture("res://items/paintings/eelworkoutguy.png");
...
Dictionary BLOCKPAINTEELWORKOUTGUY::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTEELWORKOUTGUY::onBreak(int x, int y, PLANETDATA *planet, int dir){
