#include "blockPaintKaiaWashed.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTKAIAWASHED::_bind_methods() {
}

BLOCKPAINTKAIAWASHED::BLOCKPAINTKAIAWASHED() {

    setTexture("res://items/paintings/kaiaWashed.png");
...
Dictionary BLOCKPAINTKAIAWASHED::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTKAIAWASHED::onBreak(int x, int y, PLANETDATA *planet, int dir){
