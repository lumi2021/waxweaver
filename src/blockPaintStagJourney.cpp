#include "blockPaintStagJourney.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTSTAGJOURNEY::_bind_methods() {
}

BLOCKPAINTSTAGJOURNEY::BLOCKPAINTSTAGJOURNEY() {

    setTexture("res://items/paintings/stagJourney.png");
...
Dictionary BLOCKPAINTSTAGJOURNEY::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTSTAGJOURNEY::onBreak(int x, int y, PLANETDATA *planet, int dir){
