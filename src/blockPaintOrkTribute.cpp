#include "blockPaintOrkTribute.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTORKTRIBUTE::_bind_methods() {
}

BLOCKPAINTORKTRIBUTE::BLOCKPAINTORKTRIBUTE() {

    setTexture("res://items/paintings/orkTribute.png");
...
Dictionary BLOCKPAINTORKTRIBUTE::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTORKTRIBUTE::onBreak(int x, int y, PLANETDATA *planet, int dir){
