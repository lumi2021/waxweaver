#include "blockPaintGahFine.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTGAHFINE::_bind_methods() {
}

BLOCKPAINTGAHFINE::BLOCKPAINTGAHFINE() {

    setTexture("res://items/paintings/gahItsFine.png");
...
Dictionary BLOCKPAINTGAHFINE::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTGAHFINE::onBreak(int x, int y, PLANETDATA *planet, int dir){
