#include "blockTablePink.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKTABLEPINK::_bind_methods() {
}

BLOCKTABLEPINK::BLOCKTABLEPINK() {

    setTexture("res://items/blocks/furniture/other/pinkTable.png");
...
Dictionary BLOCKTABLEPINK::onBreak(int x, int y, PLANETDATA *planet, int dir){
