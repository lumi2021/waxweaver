#include "blockPaintKaiaGhosts.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTKAIAGHOSTS::_bind_methods() {
}

BLOCKPAINTKAIAGHOSTS::BLOCKPAINTKAIAGHOSTS() {

    setTexture("res://items/paintings/kaiaGhosts.png");
...
Dictionary BLOCKPAINTKAIAGHOSTS::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTKAIAGHOSTS::onBreak(int x, int y, PLANETDATA *planet, int dir){
