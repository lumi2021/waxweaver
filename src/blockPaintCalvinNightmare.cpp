#include "blockPaintCalvinNightmare.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTCALVINNIGHTMARE::_bind_methods() {
}

BLOCKPAINTCALVINNIGHTMARE::BLOCKPAINTCALVINNIGHTMARE() {

    setTexture("res://items/paintings/calvinNightmare.png");
...
Dictionary BLOCKPAINTCALVINNIGHTMARE::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTCALVINNIGHTMARE::onBreak(int x, int y, PLANETDATA *planet, int dir){
