#include "blockPinkTreeFlowering.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPINKTREEFLOWERING::_bind_methods() {
}

BLOCKPINKTREEFLOWERING::BLOCKPINKTREEFLOWERING() {

    setTexture("res://items/blocks/foliage/trees/pinkTree/leavesFlower.png");
...
Dictionary BLOCKPINKTREEFLOWERING::onTick(int x, int y, PLANETDATA *planet, int dir){
    Dictionary changes = {};
