#include "blockPaintOrkPill.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTORKPILL::_bind_methods() {
}

BLOCKPAINTORKPILL::BLOCKPAINTORKPILL() {

    setTexture("res://items/paintings/orkPillford.png");
...
Dictionary BLOCKPAINTORKPILL::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTORKPILL::onBreak(int x, int y, PLANETDATA *planet, int dir){
