#include "blockPaintKaiaCreature.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTKAIACREATURE::_bind_methods() {
}

BLOCKPAINTKAIACREATURE::BLOCKPAINTKAIACREATURE() {

    setTexture("res://items/paintings/kaiaCreature.png");
...
Dictionary BLOCKPAINTKAIACREATURE::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTKAIACREATURE::onBreak(int x, int y, PLANETDATA *planet, int dir){
