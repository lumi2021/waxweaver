#include "blockPaintLynWorn.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTLYNWORN::_bind_methods() {
}

BLOCKPAINTLYNWORN::BLOCKPAINTLYNWORN() {

    setTexture("res://items/paintings/lynWorn.png");
...
Dictionary BLOCKPAINTLYNWORN::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTLYNWORN::onBreak(int x, int y, PLANETDATA *planet, int dir){
