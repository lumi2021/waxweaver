#include "blockPaintOctoSpiral.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTOCTOSPIRAL::_bind_methods() {
}

BLOCKPAINTOCTOSPIRAL::BLOCKPAINTOCTOSPIRAL() {

    setTexture("res://items/paintings/octoSpiral.png");
...
Dictionary BLOCKPAINTOCTOSPIRAL::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTOCTOSPIRAL::onBreak(int x, int y, PLANETDATA *planet, int dir){
