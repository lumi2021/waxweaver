#include "blockPaintStagCup.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTSTAGCUP::_bind_methods() {
}

BLOCKPAINTSTAGCUP::BLOCKPAINTSTAGCUP() {

    setTexture("res://items/paintings/stagCup.png");
...
Dictionary BLOCKPAINTSTAGCUP::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTSTAGCUP::onBreak(int x, int y, PLANETDATA *planet, int dir){
