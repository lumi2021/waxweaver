#include "blockPaintLynSmile.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTLYNSMILE::_bind_methods() {
}

BLOCKPAINTLYNSMILE::BLOCKPAINTLYNSMILE() {

    setTexture("res://items/paintings/lynSmile.png");
...
Dictionary BLOCKPAINTLYNSMILE::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTLYNSMILE::onBreak(int x, int y, PLANETDATA *planet, int dir){
