#include "blockPaintLynFish.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKPAINTLYNFISH::_bind_methods() {
}

BLOCKPAINTLYNFISH::BLOCKPAINTLYNFISH() {

    setTexture("res://items/paintings/lynFish.png");
...
Dictionary BLOCKPAINTLYNFISH::onTick(int x, int y, PLANETDATA *planet, int dir){
...
Dictionary BLOCKPAINTLYNFISH::onBreak(int x, int y, PLANETDATA *planet, int dir){
