#include "blockTrinketStation.h"
#include <godot_cpp/core/class_db.hpp>

using namespace godot;

void BLOCKTRINKETSTATION::_bind_methods() {
}

BLOCKTRINKETSTATION::BLOCKTRINKETSTATION() {

    setTexture("res://items/blocks/furniture/stations/trinketStation.png");
...
Dictionary BLOCKTRINKETSTATION::onBreak(int x, int y, PLANETDATA *planet, int dir){
